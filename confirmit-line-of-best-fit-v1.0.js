...
//setTimeout(function() { 
    ...
    // Count minor grid interval
    var x_int = mean_x - (x_min - 0.1 - 0.05 - 0.01);
    var y_int = mean_y - (y_min - 0.1 - 0.05);

    //console.log('x_int='+x_int+' y_int='+y_int);
